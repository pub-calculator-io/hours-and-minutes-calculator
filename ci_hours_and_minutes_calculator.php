...
Version: 1.0.0
Author: Hours and Minutes Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Hours and Minutes Calculator by www.calculator.io";

function display_calcio_ci_hours_and_minutes_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_hours_and_minutes_calculator', 'display_calcio_ci_hours_and_minutes_calculator' );